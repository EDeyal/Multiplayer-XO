...
public class NetworkManager : MonoBehaviour
{
    ...
    /*
        0. Ask if someone sends a message that he is first player.
        1. Tell second player that you are connected until he tells you he also connected
        2. if first player wait for cell click, if second player wait for other player
     */
}
